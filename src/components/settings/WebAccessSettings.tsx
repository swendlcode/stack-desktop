...
export function WebAccessSettings({ settings, onChange }: {
  ...
  return (
    <SettingSection
      title="Web access"
      description="Open your library in a browser while Stack is running."
    >
      <SettingRow
        label="Serve Stack in a browser"
        description="Serve the app on this computer."
      >
        <Toggle
      ...
      <SettingRow
        ...
        description="Let phones and other machines on this Wi-Fi reach it."
      >
        <Toggle
      ...
      {settings.webAccessLan && (
        <div className="mx-3 flex gap-2.5 rounded-lg border border-stack-fire/40 bg-stack-ember/30 px-3 py-2.5 text-xs text-gray-300">
          ...
          <p>Anyone with this link can browse and edit your library. Treat it like a password.</p>
        </div>
      )}
