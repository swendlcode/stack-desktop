...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::stack_commands::list_stacks,
            commands::stack_commands::create_stack,
            commands::stack_commands::rename_stack,
            commands::stack_commands::set_stack_color,
            commands::stack_commands::delete_stack,
            commands::stack_commands::add_asset_to_stack,
            commands::stack_commands::remove_asset_from_stack,
            commands::stack_commands::get_stack_assets,
